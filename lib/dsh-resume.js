...
const SESSION_READER_PATH = join(PLUGIN_ROOT, "resources", "session_reader.py");
	...
	ctx.tools.register(defineTool({
		...
		async execute(args, exec) {
			...
			return await runSessionReader({
				...
				cwd,
				...args.reference === void 0 ? {} : { reference: args.reference },
...
//#endregion
export { RESUME_SKILL_SPECS, SESSION_READER_PATH, apply, buildReaderArgs, inject, name, resumeSkillContent, runSessionReader, skillRegistration };
